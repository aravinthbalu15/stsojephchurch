        ...
        <Container key={group._id} className="anbiyangal-container mt-5 mb-5" data-aos="fade-up">
          ...
          <div className="inner-wrapper">
            <Row className="align-items-center">
              ...
              <Col md={6} className="d-flex flex-column align-items-start right-side order-1 order-md-2" data-aos="fade-left">
              ...
              <Col md={6} className="d-flex flex-column align-items-start gap-4 left-side order-2 order-md-1" data-aos="fade-right">
