    ...
    <div className="heart-convent container">
      ...
      <div className="row justify-content-center scroll-reveal">
        {dynamicImages.map((img, index) => (
          <div key={img._id || index} className="col-sm-6 col-md-4 mb-4 d-flex flex-column align-items-center text-center">
            <img src={img.imageUrl} alt={img.name} className="img-fluid rounded-circle shadow gallery2-img" />
