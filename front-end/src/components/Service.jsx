...
const Service = () => {
  ...
  const persons = [
    { img: Image1, key: "person1" },
    { img: Image2, key: "person2" },
    { img: Image3, key: "person3" },
    { img: Image4, key: "person4" },
    { img: Image5, key: "person5" },
    { img: Image6, key: "person6" }
  ];
      ...
      {persons.map((p) => (
        <div className="row align-items-center my-5" key={p.key}>
          ...
          <div className="col-md-8">
            <p><strong>{t("Name")}:</strong> {t(`${p.key}_name`)}</p>
